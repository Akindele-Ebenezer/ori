...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('daily_reports', function (Blueprint $table) {
            $table->id(); $table->string('Vessel')->nullable(); $table->string('DeployedVessel1')->nullable(); $table->string('DeployedVessel2')->nullable(); $table->string('DeployedVessel3')->nullable(); $table->string('Status'); $table->string('DoneBy'); $table->text('Remarks')->nullable(); $table->string('StartTime')->nullable(); $table->string('EndTime')->nullable(); $table->date('StartDate'); $table->date('EndDate'); $table->string('TillNow')->default('NO'); $table->date('DateIn')->nullable(); $table->string('TimeIn')->nullable(); $table->timestamps();
        });
