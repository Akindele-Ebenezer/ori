<div class="DevicesFormWrapper FormWrapper Hide">
    <form action="" class="AddDevicesForm" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="inner-1"> 
            <div class="fields">
    ...
    <button class="AddDevicesButton">Create →</button>
</div>