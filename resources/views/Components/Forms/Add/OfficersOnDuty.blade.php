<div class="OfficersOnDutyFormWrapper FormWrapper Hide">
    <form action="" class="AddOfficersOnDutyForm" enctype="multipart/form-data" method="POST">
        @csrf
        <div class="inner-1"> 
            <div class="fields">
                ...
                <section>
                    <div class="input">
                        <label for="officers-supervisor">Supervisor</label>
                        <select name="Supervisor" id="officers-supervisor">
    ...
    <button class="AddOfficersOnDutyButton">Create →</button>
</div>