<div class="form-1 EditGenerator">
    <div class="inner">
        <div class="close-button close-edit-generator-form-button">
            <span>    </span>
            <button class="cancel-button-generator">✖</button>
        </div>
        <form action="" class="EditGeneratorForm" enctype="multipart/form-data" method="POST">
            @csrf
            <div class="inner-1"> 
                <div class="fields">
        ...
        <button class="EditGeneratorButtonX">Update →</button>
    </div>
</div>