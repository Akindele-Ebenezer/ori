<div class="form-1 DailyReportFilter">
    <div class="inner">
        <div class="close-button">
            <span>    </span>
            <button class="cancel-button-filter-by-date">✖</button>
        </div>
        <form action="" class="DailyReportFilterForm"> 
            <div class="inner-1"> 
                <div class="fields">
                    <p class="error-daily-report-filter error"></p> 
                    <section>
                        <div class="input">
                            <label for="">From date</label>
                            <input type="date" name="FromDate_DAILYREPORTFILTER">
                        </div>  
                    </section> 
                </div>
            </div>
            <div class="inner-2">  
                <section>
                    <div class="input">
                        ...
                        <input type="date" name="EndDate_DAILYREPORTFILTER">
                    </div>  
                </section> 
            </div>
            <div class="inner-2">  
                <section>
                    <div class="input">
                        ...
                        <input type="date" name="DailyReportFilter_SpecificDay">
                    </div>  
                </section> 
            </div>
        </form>
        <section class="">
            <div class="footer">
                ...
                <button class="DailyReportFilter_GoButton">Go →</button>
            </div>
        </section>
    </div>
</div>